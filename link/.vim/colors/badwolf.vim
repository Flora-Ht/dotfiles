...
call s:HL('TabLineSel', 'coal', 'snow', 'none')
...
call s:HL('IncSearch', 'coal', 'snow',    'bold')
...
call s:HL('ErrorMsg',   'tardis',       'bg', 'bold')
...
call s:HL('String', 'saltwatertaffy')
...
call s:HL('Constant',  'orange', '', 'bold')
call s:HL('Character', 'orange', '', 'bold')
call s:HL('Boolean',   'orange', '', 'bold')

call s:HL('Number', 'orange', '', 'bold')
call s:HL('Float',  'orange', '', 'bold')
